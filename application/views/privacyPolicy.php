...
<head>
	...
	if (screen.width <= 800) { window.location.replace("http://m.campuspuppy.com/privacy-policy"); }
	</script>
</head>
	...
	<div class="layout-container flex flex--col">
		...
		<main class="flex main-container globalContainer" style="margin-top: 10px;">
			<div class="main-body flex__item">
				<div class="card">
					<h1 style="font-size: 1rem; text-transform: uppercase; text-align: left; margin-top: 0;"><b>Privacy Policy</b></h1>
					<?php echo $privacypolicy[0]['privacyPolicy']; ?>
				</div>
			</div>
