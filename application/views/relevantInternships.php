			...
			<aside class="flex__item left-pane">
				...
				<div class="card card--no-padding">
					<div class="nav nav--stacked js-nav--stacked">
						<a href="<?php echo base_url('jobs/relevant-jobs'); ?>" class="nav__link js-nav-link active">Relevant Internship Offers</a>
						<a href="<?php echo base_url('jobs/job-offers'); ?>" class="nav__link js-nav-link">Browse Internship Offers</a>
						<a href="<?php echo base_url('jobs/applied-job-offers'); ?>" class="nav__link js-nav-link">Applied Internship Offers</a>
					</div>
				</div>
			...
			<div class="main-body flex__item">
				<div class="card">
					<ol class="breadcrumb">
						...
						<li class="active">Relevant Internship Offers</li>
					</ol>
				</div>
