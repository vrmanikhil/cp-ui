<div class="explore-panel card flex">
  <a href="javascript:" class="explore-panel__link flex flex--col flex__item align-center">
    <span class="explore-panel__link-img-container">
      <img class="explore-panel__link-img flex__item" src="<?php echo base_url('/assets/img/icons/navigation/jobs.png'); ?>" alt="">
    </span>
    <span class="explore-panel__link-text flex__item">Jobs</span>
  </a>
  <a href="javascript:" class="explore-panel__link flex flex--col flex__item align-center">
    <span class="explore-panel__link-img-container">
      <img class="explore-panel__link-img flex__item" src="<?php echo base_url('/assets/img/icons/navigation/internships.png'); ?>" alt="">
    </span>
    <span class="explore-panel__link-text flex__item">Internships</span>
  </a>
  <a href="javascript:" class="explore-panel__link flex flex--col flex__item align-center">
    <span class="explore-panel__link-img-container">
      <img class="explore-panel__link-img flex__item" src="<?php echo base_url('/assets/img/icons/navigation/skills.png'); ?>" alt="">
    </span>
